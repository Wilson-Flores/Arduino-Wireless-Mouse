...
const int ncs = 31;  //This is the SPI1 "slave select" pin that the sensor is hooked up to
...
//  Serial.println("Uploading firmware...");
  ...
  adns_com_begin();
  SPI1.transfer(SROM_Load_Burst | 0x80); // write burst destination adress
...
void dispRegisters(void){
  ...
  for(rctr=0; rctr<4; rctr++){
    SPI1.transfer(oreg[rctr]);
    delay(1);
//    Serial.println("---");
//    Serial.println(oregname[rctr]);
//    Serial.println(oreg[rctr],HEX);
    regres = SPI1.transfer(0);
